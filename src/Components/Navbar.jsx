...
import logo from '../assets/sula_logo.png'
  ...
  return (
    <div className='navbar'>
        ...
        <ul ref={menuRef} className='nav-menu'>
            <img src={menu_close} alt='' onClick={closeMenu} className='nav-mob-close'></img>
            ...
            <li><AnchorLink className="anchor-link" offset={50} href="#services"><p onClick={()=> setMenu("services")}>Skills</p></AnchorLink>{menu == "services"? <img src={underline} alt=''></img>: <></>}</li>
